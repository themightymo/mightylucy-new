...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-content">
		...
		if($doneornot->slug=='done'){ //if done
		   $radiobuttons='<tr><td><h5>Status:</h5></td><td><input id="tactive"  name="tstatus_story" class="active user_story_status" type="radio"  value="activexxx'.get_the_ID().'"> Active</td><td><input id="tdone"   name="tstatus_story" class="done user_story_status"  type="radio"  value="donexxx'.get_the_ID().'" checked> Done</td><td><input id="ton-hold" name="tstatus_story" class="on-hold user_story_status"  type="radio"  value="on-holdxxx'.get_the_ID().'">On Hold</td><td><input id="tready-for-client-review" name="tstatus_story" class="ready-for-client-review user_story_status"  type="radio"  value="ready-for-client-reviewxxx'.get_the_ID().'" >Ready On Client Review</td></tr>';		
		}elseif($doneornot->slug=='active'){ //if active
			$radiobuttons='<tr><td><h5>Status:</h5></td><td><input id="tactive"  name="tstatus_story" class="active user_story_status" type="radio"  value="activexxx'.get_the_ID().'"  checked> Active</td><td><input id="tdone" name="tstatus_story" class="done user_story_status"  type="radio"  value="donexxx'.get_the_ID().'"> Done</td><td><input id="ton-hold" name="tstatus_story" class="on-hold user_story_status"  type="radio"  value="on-holdxxx'.get_the_ID().'">On Hold</td><td><input id="tready-for-client-review" name="tstatus_story" class="ready-for-client-review user_story_status"  type="radio"  value="ready-for-client-reviewxxx'.get_the_ID().'" >Ready On Client Review</td></tr>'; 
		}elseif($doneornot->slug=='on-hold'){ //if onhold
			$radiobuttons='<tr><td><h5>Status:</h5></td><td><input id="tactive"  name="tstatus_story" class="active user_story_status" type="radio"  value="activexxx'.get_the_ID().'"> Active</td><td><input id="tdone" name="tstatus_story" class="done user_story_status"  type="radio"  value="donexxx'.get_the_ID().'"> Done</td><td><input id="ton-hold" name="tstatus_story" class="on-hold user_story_status"  type="radio"  value="on-holdxxx'.get_the_ID().'" checked>On Hold</td><td><input id="tready-for-client-review" name="tstatus_story" class="ready-for-client-review user_story_status"  type="radio"  value="ready-for-client-reviewxxx'.get_the_ID().'" >Ready On Client Review</td></tr>'; 
		}else{ //if onhold
			$radiobuttons='<tr><td><h5>Status:</h5></td><td><input id="tactive"  name="tstatus_story" class="active user_story_status" type="radio"  value="activexxx'.get_the_ID().'"> Active</td><td><input id="tdone" name="tstatus_story" class="done user_story_status"  type="radio"  value="donexxx'.get_the_ID().'"> Done</td><td><input id="ton-hold" name="tstatus_story" class="on-hold user_story_status"  type="radio"  value="on-holdxxx'.get_the_ID().'">On Hold</td><td><input id="tready-for-client-review" name="tstatus_story" class="ready-for-client-review user_story_status"  type="radio"  value="ready-for-client-reviewxxx'.get_the_ID().'" checked>Ready On Client Review</td></tr>'; 
		}
		?>
